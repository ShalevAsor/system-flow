...
//       const timeStep = TICK_INTERVAL * state.simulationSpeed;
...
//             (sum, req) => {
//               const responseTime = req.completedAt! - req.createdAt;
//               // Cap at 10 seconds to prevent outliers
//               return sum + Math.min(responseTime, 10000);
//             },
//             0
//           );
...
//       // Step 6: Update metric history if needed
